      ...
      <div className="w-full max-w-4xl p-6 bg-white shadow-md md:p-8 rounded-xl">
        ...
        <div className="flex flex-col gap-4 mb-6 md:flex-row">
          <button
            ...
            className={`cursor-pointer flex-1 py-2 px-4 rounded-md !text-white font-medium ${loading || !employee?._id
          ...
          <button
            ...
            className={`cursor-pointer flex-1 py-2 px-4 rounded-md !text-white font-medium ${loading || todaysLogs.length === 0 || !employee?._id
                    ...
                    <div className="grid grid-cols-1 gap-4 p-5 text-sm text-gray-700 md:grid-cols-2">
                      ...
                      <div className="space-y-2">
                        <p>
                          ...
                          <span
                            className={`ml-2 px-2 py-1 rounded-full text-xs font-medium ${log.wasSaleConverted === 'Yes'
        ...
        <button
          ...
          disabled={loading}
          className={`mt-6 w-full py-2 rounded shadow font-semibold ${loading ? 'bg-gray-400 cursor-not-allowed' : 'bg-red-300 hover:bg-red-600 text-white cursor-pointer'
            }`}
        >
