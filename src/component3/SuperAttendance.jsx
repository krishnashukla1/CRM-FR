...
//   // Keep all the same state as the admin version
...
//   // Keep all the same useEffect hooks
//   useEffect(() => {
//     fetchEmployees();
//     fetchAttendance();
//   }, [page]);

//   // Keep all the same helper functions (fetchEmployees, fetchAttendance, handleStatusChange, etc.)
...
//   // Keep all the same filtering and utility functions
...
//   // MAIN RETURN - Remove Layout wrapper and adjust any supervisor-specific UI
...
//         {/* Summary Stats */}
//         <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6 ml-18  mr-18 w-7xl">
...
//             </div>
//           ) : (
//             <div className="overflow-x-auto rounded-lg shadow-md max-w-7xl mx-auto">
...
//       const excelData = [
//         ['Employee Name', 'Email', 'Date', 'Status', 'Recorded At'],
//         ...dataToExport.map(att => [
//           att.employeeId?.name || 'N/A',
//           att.employeeId?.email || 'N/A',
//           new Date(att.date).toLocaleDateString(),
...
//   return (
//     <div className="p-4 md:p-6 min-h-screen bg-gray-100 text-gray-900">
//       {/* Main container with max-width for better desktop experience */}
//       <div className="max-w-screen-2xl mx-auto">
//         <h2 className="text-2xl md:text-3xl font-bold mb-6 text-center text-indigo-700">
//           👥 Team Attendance Overview
//         </h2>

//         {/* Filters - Centered with responsive width */}
//         <div className="flex flex-col sm:flex-row justify-center gap-4 mb-6 flex-wrap max-w-4xl mx-auto">
//           <select
//             className="p-2 rounded-lg bg-white text-black shadow-md border border-gray-200 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 flex-grow sm:flex-grow-0"
//             value={filter.employeeId}
//             onChange={e => setFilter({ ...filter, employeeId: e.target.value })}
//           >
//             <option value="">All Employees</option>
...
//             value={selectedMonth}
//             onChange={(e) => setSelectedMonth(parseInt(e.target.value))}
//             className="p-2 rounded-lg bg-white text-black shadow-md border border-gray-200 flex-grow sm:flex-grow-0"
//             disabled={!!filter.date}
//           >
//             {Array.from({length: 12}, (_, i) => (
//               <option key={i+1} value={i+1}>
...
//     const year = 2025 + i; // starts at 2025 → 2034
//     return (
...
//         {/* Summary Stats - Centered with proper width */}
...
//         {/* Mobile Cards View */}
//         <div className="sm:hidden space-y-4 max-w-2xl mx-auto">
//           {paginated.length === 0 ? (
//             <div className="bg-white p-6 rounded-lg shadow-md text-center">
//               <p className="text-gray-500">No attendance records found for selected filters</p>
//             </div>
...
//         {/* Desktop Table View - Now with proper container and scrolling */}
//         <div className="hidden sm:block">
//           {paginated.length === 0 ? (
...
//             </div>
//           ) : (
//             <div className="overflow-x-auto rounded-lg shadow-md max-w-full">
...
//                       <th className="p-3 text-left min-w-[150px]">Action</th>
//                     </tr>
//                   </thead>
//                   <tbody>
//                     {paginated.map((att) => (
...
//                             value={att.status}
//                             onChange={e => handleStatusChange(att._id, e.target.value)}
//                             className="p-2 rounded-lg bg-white text-black shadow border border-gray-200 w-full max-w-[180px]"
//                           >
//                             <option value="Present">Present</option>
//                             <option value="Absent">Absent</option>
//                             <option value="Leave">Leave</option>
...
//                     <thead className="bg-indigo-200">
//                       <tr>
//                         <th className="p-3 text-center min-w-[180px]">Employee</th>
//                         {/* <th className="p-3 text-center min-w-[200px]">Email</th> */}
//                         <th className="p-3 text-center min-w-[120px]">Date</th>
//                         <th className="p-3 text-center min-w-[120px]">Status</th>
//                         {/* <th className="p-3 text-left min-w-[200px]">Reason</th> */}
//                         <th className="p-3 text-center min-w-[150px]">Action</th>
//                       </tr>
//                     </thead>
//                     <tbody>
//                       {attendance.map((att) => (
        ...
        <div className="flex justify-center gap-4 mb-6">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 16l-6-6h4V4h4v6h4l-6 6zM4 20h16v2H4z" />
            </svg>
