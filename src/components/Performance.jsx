...
//   return (
//   <div className="p-6 max-w-xl mx-auto mt-10 bg-white shadow-2xl rounded-2xl border border-gray-200">
...
//             required
//             className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 appearance-none"
//           >
