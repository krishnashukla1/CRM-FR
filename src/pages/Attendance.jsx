...
//           <select
//             className="p-2 text-black bg-white border border-gray-200 rounded-lg shadow-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
...
//             className="p-2 text-black bg-white border border-gray-200 rounded-lg shadow-md"
...
//         {/* Summary Stats */}
//         <div className="grid grid-cols-1 gap-4 mb-6 md:grid-cols-3 px-30 w-7xl">
...
//           </div>
//           <div className="p-4 text-center bg-white rounded-lg shadow-md">
//             <h3 className="text-sm font-medium text-gray-500">Absent/Leave</h3>
...
//             </div>
//           ) : (
//             <div className="max-w-6xl mx-auto overflow-x-auto rounded-lg shadow-md">
...
//                           value={att.status}
//                           onChange={e => handleStatusChange(att._id, e.target.value)}
//                           className="p-2 text-black bg-white border border-gray-200 rounded-lg shadow"
//                         >
//                           <option value="Present">Present</option>
//                           <option value="Absent">Absent</option>
//                           <option value="Leave">Leave</option>
...
//           </div>
//           <div className="p-4 text-center bg-white rounded-lg shadow-md">
//             <h3 className="text-sm font-medium text-gray-500">Leave/Weekly Off</h3>
...
//         {/* Summary Stats */}
//         <div className="grid grid-cols-1 gap-4 mb-6 md:grid-cols-5 px-30 w-7xl">
//           <div className="p-4 text-center bg-white rounded-lg shadow-md">
//             <h3 className="text-sm font-medium text-gray-500">Total Records</h3>
//             <p className="text-2xl font-bold">{filtered.length}</p>
//           </div>
...
//                     </select>
//                   ) : (
//                     <span className="text-sm italic text-gray-500">System Generated</span>
//                   )}
//                 </div>
//               </div>
//             ))
...
//                           </select>
//                         ) : (
//                           <span className="italic text-gray-500">System Generated</span>
//                         )}
//                       </td>
//                     </tr>
//                   ))}
